...
select lives_ok(format($q$select set_item_price(%L::uuid,%L::uuid,'retail',1,200,'p6-price')$q$,current_setting('p6.item'),current_setting('p6.shop')),'set retail price for discount test');
