...
export function InventoryScreen() {
  ...
  async function addItem(ev:Event){ ev.preventDefault(); setError(''); if(!tenantId){setError('Shop data is still loading.');return;} const f=new FormData(ev.currentTarget as HTMLFormElement);
  ...
  async function addBarcode(ev:Event){ ev.preventDefault(); if(!tenantId){setError('Shop data is still loading.');return;} if(!selectedItem)return; const f=new FormData(ev.currentTarget as HTMLFormElement);
  ...
  async function addParty(ev:Event){ ev.preventDefault(); setError(''); if(!tenantId){setError('Shop data is still loading.');return;} const f=new FormData(ev.currentTarget as HTMLFormElement);
