...
export function InventoryScreen() {
  ...
  const [purchaseClientId,setPurchaseClientId]=useState(()=>crypto.randomUUID()); const [purchaseBusy,setPurchaseBusy]=useState(false); const [message,setMessage]=useState(''); const [error,setError]=useState('');
